		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "판매실적에 기반한 ai 분석",
									"targetURL": "#synceasalesai-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"synceasalesai-display": {
								"semanticObject": "synceasalesai",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync.ea.salesai",
									"url": sap.ui.require.toUrl("sync/ea/salesai")
								}
							}
						}
					}
